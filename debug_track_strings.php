...
function debugTrackRow($pageData, $offset, $pdbParser, $trackNum) {
    try {
        ...
        echo "\n=== TRACK {$trackNum} (ID: {$fixed['id']}) ===\n";
        echo "Track ID: {$fixed['id']}\n";
        echo "BPM: " . round($fixed['tempo'] / 100.0, 2) . "\n";
        ...
        echo "Error parsing track: " . $e->getMessage() . "\n";
        return null;
    }
}
...
for ($pageIdx = $firstPage; $pageIdx <= $lastPage; $pageIdx++) {
    ...
    for ($rowIdx = 0; $rowIdx < $numRows; $rowIdx++) {
        ...
        $trackCount++;
        debugTrackRow($pageData, $actualRowOffset, $pdbParser, $trackCount);
